    ...
    <>
      ...
      <div className="max-w-6xl mx-auto">
        <PageHeader
          eyebrow="Overview"
          title="Dashboard"
          description="Portfolio snapshot and your investment preferences."
        />
        ...
        {loading ? (
          ...
          <div className="panel p-6 text-center">
            <h3 className="label mb-3">Total portfolio value</h3>
          ...
          <div className="panel p-6 text-center">
            <h3 className="label mb-3">Accounts</h3>
            <p className="stat-value text-ink">{accounts.length}</p>
          </div>

          <div className="panel p-6">
            <h3 className="label mb-2 text-center">Asset allocation</h3>
          ...
          <div className="panel p-6 text-center">
            <h3 className="label mb-3">Last analysis</h3>
            <p className="stat-value text-ink text-xl">
        ...
        <div className="panel p-6 mb-8">
          <h2 className="font-display text-xl font-semibold text-ink mb-6">Preferences</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="label">Target retirement income (annual)</label>
              <input
                type="text"
            ...
            {/* Target Allocations */}
            <div>
              <h3 className="label mb-3">Target asset class allocation</h3>
              <div className="space-y-3">
                <div>
                  <label className="text-sm text-muted">Equity: {equityTarget}%</label>
                  <input
                    type="range"
                    min="0"
                    max="100"
                ...
                <div>
                  <label className="text-sm text-muted">Fixed income: {fixedIncomeTarget}%</label>
                  <input
                    type="range"
                    min="0"
                    max="100"
            ...
            <div>
              <h3 className="label mb-3">Target regional allocation</h3>
              <div className="space-y-3">
                <div>
                  <label className="text-sm text-muted">North America: {northAmericaTarget}%</label>
                  <input
                    type="range"
                    min="0"
                    max="100"
                ...
                <div>
                  <label className="text-sm text-muted">International: {internationalTarget}%</label>
                  <input
                    type="range"
                    min="0"
                    max="100"
