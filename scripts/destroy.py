#!/usr/bin/env python3
"""
Destroy the Alex frontend and API infrastructure.
This script:
...
def confirm_destruction():
    ...
    print("  WARNING: This will destroy frontend and API infrastructure!")
    print("This includes:")
...
def main():
    ...
    print(" Alex — frontend infrastructure teardown")
    print("=" * 60)
