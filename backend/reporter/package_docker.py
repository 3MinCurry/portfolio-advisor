...
def package_lambda():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        sec_rag_src = backend_dir / "sec_rag"
        sec_rag_dst = package_dir / "sec_rag"
        sec_rag_dst.mkdir()
        for name in ("__init__.py", "paths.py", "retrieval.py"):
            shutil.copy(sec_rag_src / name, sec_rag_dst / name)
